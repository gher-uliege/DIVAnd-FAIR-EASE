...
# ╔═╡ 98b76210-e31a-4b86-93ea-ddf89537731f
begin
	using Dates
	using DIVAnd
	using Downloads
...
# ╔═╡ ccc9aefc-a330-11ef-1df8-a1676cbd3ad7
md"""
# Create a climatology in the North Adriatic Sea
"""

# ╔═╡ fb799ef7-3691-40fb-952f-f8e929fd6c69
...
# ╔═╡ 15133ebf-b873-4d17-9713-ac2b586ec2ad
begin
	regionname = "North_Adriatic"
	coords = domaininfo["North_Adriatic"]
	dx, dy = 0.05, 0.05
	lonr = coords[1]:dx:coords[2]
	latr = coords[3]:dy:coords[4]
	timerange = [Date(1950,1,1),Date(2024,12,31)];
...
# ╔═╡ dd31ba58-6a21-487b-8770-d4eb64e8e696
md"""
## Load bathymetry
"""

# ╔═╡ f0d70fbe-efe1-4b35-9f47-3f89ba2bf69e
begin
	datadir = "../data/"
...
# ╔═╡ c9025ed9-03da-49f2-a769-ce5bdaa575b9
begin
	figbathy = GeoMakie.Figure()
    ga1 = GeoAxis(figbathy[1, 1];  dest = "+proj=merc", title = "GEBCO bathymetry")
    hm1 = heatmap!(ga1, bx, by, -b, interpolate = false, colorrange=(-400., 400), colormap=:delta)
    xlims!(ga1, (bx[1], bx[end]))
    ylims!(ga1, (by[1], by[end]))
    contour!(ga1, bx, by, b, levels=[0.], color=:black)
    Colorbar(figbathy[2, 1], hm1, vertical = false, label = "(m)")
    figbathy
end

# ╔═╡ 0186cb27-786e-4cee-83d3-b4e5e3a07399
"""
...
# ╔═╡ 2a9c782f-8346-4630-898b-675f886062a8
begin
	fig, ga = plot_mask(mask[:,:,1], depthr[1]);
	fig
end

# ╔═╡ dca2b6fe-f909-41de-a755-c5a804fb2b12
begin
...
# ╔═╡ 6ee676ad-e46c-4383-af20-15d881424ce8
begin
	maskfilled = label .== 1
	plot_mask(maskfilled[:,:,1], depthr[1])
end

# ╔═╡ 2cfbef5e-2053-4471-8bda-66d6cfd8d420
md"""
## Load the observations
"""

# ╔═╡ 84ec64b7-216b-4ceb-81cf-0f9d396d1b7d
begin 
	datafile = "../data/NorthAdriatic/merged/North_Adriatic_test.nc"
	obsval, obslon, obslat, obsdepth, obstime, obsid = loadobs(Float64, datafile, "temperature")
end

# ╔═╡ e1d0ac33-d8f1-414e-bf11-4506a0b4601e
begin
...
# ╔═╡ faf9c7c8-1ea7-45e5-8ada-c767b1a0e7d7
md"""
### Compute data weigth
"""

# ╔═╡ ddbc39ac-b303-4e8e-831e-d7543ef8ae4c
begin
	@time rdiag=1.0./DIVAnd.weight_RtimesOne((obslon,obslat),(0.03,0.03));
	@show maximum(rdiag),mean(rdiag)
end

# ╔═╡ f4b614ee-980f-4395-94fd-31695e53a9d7
md"""
...
# ╔═╡ 4f529a53-87e3-4aa8-9aa7-6c2958453861
begin 
...
# ╔═╡ 04f41099-2690-4a69-9264-be97a698481c
begin
...
manifest_format = "2.0"
project_hash = "2eaaad9728d89c921ce712dd148efe29b96f7698"
