...
begin
	...
	title="Observations in the Northern Adriatic Sea")
	...
	for (iii, outputfile) in enumerate(outputfilelist)
		NCDataset(outputfile, "r") do ds
			...
			lon = ds["LONGITUDE"][:]
			lat = ds["LATITUDE"][:]
			plot!(ga, lon, lat, color=colorlist[iii], markersize=3,
				label=datasource)
		end
...
# ╔═╡ 52293f5e-2218-46b1-9258-5c60b9ad6f99
GeoMakie.assetpath()
...
manifest_format = "2.0"
project_hash = "8f24c2e1ff99936a2b9e82ecf7d94e6f67fc7146"
